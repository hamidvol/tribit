    ...
    <body>
        ...
        <div class="container text-center pt30 pb30">
            <form method="post" action="index-.php">
                ...
                <button type="submit" class="btn btn-primary" name="to" value="app">APP</button>
                <button type="submit" class="btn btn-primary" name="to" value="pin">PIN</button>
                ...
                <button type="button" class="btn btn-success" href="#sms">SMS</button> 
                <button type="button" class="btn btn-danger" href="#errorsms">SMS</button>				
